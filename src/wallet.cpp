...
// tappingcoin: total coins staked (non-spendable until maturity)
...
// tappingcoin: check 'spent' consistency between wallet and txindex
// tappingcoin: fix wallet spent state according to txindex
...
// tappingcoin: disable transaction (only for coinstake)
