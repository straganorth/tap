...
!define URL http://www.tappingcoin.ru/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/tappingcoin.ico"
...
#!define MUI_FINISHPAGE_RUN $INSTDIR\tappingcoin-qt.exe
...
OutFile tappingcoin-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/tappingcoin-qt.exe
    ...
    #Delete /REBOOTOK $INSTDIR\tappingcoin.exe
...
Section /o -un.Main UNSEC0000
    #Delete /REBOOTOK $INSTDIR\tappingcoin-qt.exe
